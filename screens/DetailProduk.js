...
import { Image, StyleSheet, View, Text, ScrollView, FlatList, Modal, TouchableOpacity, Alert } from "react-native";
...
const DetailProduk = () => {
    ...
    const { photo_url, bedroom, bathroom, description, photoo, images, name, location, item_name, price, phonenumber,email,position } = route.params;
...
const styles = StyleSheet.create({
    ...
    descriptionText: {
        ...
        fontSize: FontSize.size_base,
        textAlign: "left",
        marginTop: 4, // Add some margin to separate from the label
...
    },
    ...
    detailProduk: {
        ...
        flex: 1,
        width: "100%",
        minHeight: 812, // Adjust as needed for minimum height
        overflow: "hidden",
    },
    galleryImage: {
        width: 70,
